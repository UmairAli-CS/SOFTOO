    ...
    <li className="nc-NavItem relative" data-nc-id="NavItem">
      ...
      <button
        className={`block !leading-none font-medium whitespace-nowrap ${className} ${radius} ${isActive
          ...
          : "text-neutral-500 dark:text-neutral-400 dark:hover:text-neutral-100 hover:text-neutral-800 hover:bg-neutral-100/75 dark:hover:bg-neutral-800 focus:outline-none"}`}
        onClick={() => {
          onClick && onClick();
        }}
      >
